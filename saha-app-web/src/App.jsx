                    ...
                    <div style={{ textAlign: 'center', marginTop: '80px' }}>
                        ...
                        {!session ? (
                            <div style={{ display: 'flex', gap: '20px', justifyContent: 'center' }}>
                                <button onClick={() => setView('register')} style={{ background: '#10b981', color: 'white', border: 'none', padding: '16px 32px', borderRadius: '12px', fontSize: '18px', fontWeight: 'bold', cursor: 'pointer', boxShadow: '0 8px 15px rgba(16, 185, 129, 0.3)', transition: 'transform 0.2s' }}>
                                    Hemen Üye Ol
                                </button>
                                <button onClick={() => setView('login')} style={{ background: 'white', color: '#1e293b', border: '2px solid #e2e8f0', padding: '16px 32px', borderRadius: '12px', fontSize: '18px', fontWeight: 'bold', cursor: 'pointer' }}>
                                    Zaten Hesabım Var
                                </button>
                            </div>
                        ) : (
                            <button onClick={() => setView('profile')} style={{ background: '#3b82f6', color: 'white', border: 'none', padding: '16px 32px', borderRadius: '12px', fontSize: '18px', fontWeight: 'bold', cursor: 'pointer' }}>
